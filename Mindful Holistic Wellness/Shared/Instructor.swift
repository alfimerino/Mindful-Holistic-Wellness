...
struct Instructor: Identifiable {
    ...
    static func getInstructor(_ name: Instructors) -> Instructor {
        switch name {
        case .aurora:
            Instructor(name: "Aurora Moon", title: "Yoga Engineer", bio: "Greetings, luminous souls! I'm Aurora Moon, your dedicated yoga mentor under the celestial canopy. With boundless energy and a sprinkle of stardust, I guide you on an illuminating yoga journey. Armed with Quantum Yoga Philosophy expertise, I assist you in harmonizing your being with the cosmos. Join me in inhaling cosmic wisdom and exhaling tranquility. Together, let's embrace the cosmic flow. Namaste, cosmic companions! 🌠🌌", imageName: "Dana2")
        case .luna:
